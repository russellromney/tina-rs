# Phase 050: Specimen Round 2 Harder Pressure

## Goal

Run the second Specimen discovery pass after 047 lands.
...
- root-level Specimen comparison suite;
...
- Same Specimen discipline: paired Tokio-vs-Tina where it makes sense.
...
1. **Round-1 Regression Pass**
   ...
   Rerun the existing Specimen comparisons after 047.
...
19. **Real Load Driver On Chat**
   ...
   - deliver the driver promised by `specimen_real_io_chat`;
   ...
   - make `specimen_cpu_run` and `specimen_mem_run` reports useful;
