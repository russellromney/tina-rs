...
6. **Docs: Betelgeuse Is Canonical Portable Backend**
   ...
   Linux and macOS use Betelgeuse native backends.
   A duplicate Tina-owned backend is evidence-gated.
   ```
...
- Future Betelgeuse backend work has a clearer driver contract
  to satisfy.
