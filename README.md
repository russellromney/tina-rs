...
| Command | Purpose |
|---|---|
| `make verify` | Full project gate: fmt, clippy, tests, miri, simulator, cost smoke. CI runs it as three parallel jobs (`verify-static`, `test`, `verify-guards`); locally it's still one command. |
