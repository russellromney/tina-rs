...
```bash
cargo run --manifest-path examples/eiffel_webhook_publisher/Cargo.toml -- compare
cargo run --manifest-path examples/eiffel_webhook_publisher/Cargo.toml -- tokio
cargo run --manifest-path examples/eiffel_webhook_publisher/Cargo.toml -- tina
```
