...
```sh
cargo run --manifest-path examples/specimen_graceful_shutdown/Cargo.toml -- tokio
cargo run --manifest-path examples/specimen_graceful_shutdown/Cargo.toml -- tina
```
