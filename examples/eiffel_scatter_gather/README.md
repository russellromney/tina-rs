...
```sh
cargo run --manifest-path examples/eiffel_scatter_gather/Cargo.toml -- both
cargo run --manifest-path examples/eiffel_scatter_gather/Cargo.toml -- tokio
cargo run --manifest-path examples/eiffel_scatter_gather/Cargo.toml -- tina
```
