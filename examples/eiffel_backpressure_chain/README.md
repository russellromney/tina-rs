...
```sh
cargo run --manifest-path examples/eiffel_backpressure_chain/Cargo.toml -- both
cargo test --manifest-path examples/eiffel_backpressure_chain/Cargo.toml
```
