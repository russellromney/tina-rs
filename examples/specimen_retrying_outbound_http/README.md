# specimen_retrying_outbound_http
...
```sh
cargo run --manifest-path examples/specimen_retrying_outbound_http/Cargo.toml -- both
cargo test --manifest-path examples/specimen_retrying_outbound_http/Cargo.toml
```
