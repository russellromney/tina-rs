...
```sh
cargo run --manifest-path examples/eiffel_tower_timeout_counter/Cargo.toml -- both
cargo test --manifest-path examples/eiffel_tower_timeout_counter/Cargo.toml
```
