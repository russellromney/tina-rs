...
//!
//! Wraps an existing eiffel comparison and runs it under a process-level
...
//!
//! Usage:
//!   eiffel-mem-run [comparison-manifest] [tiers-mb-comma-separated]
//!
//! Defaults: `examples/eiffel_real_io_chat/Cargo.toml` and `512,256,128`.
...
fn main() {
    ...
    println!(
        "comparison=eiffel_mem_run manifest={} tiers_mb={:?} platform={}",
        manifest_label,
        tiers_mb,
        platform_label(),
    );
