...
```sh
cargo run --manifest-path examples/eiffel_graceful_drain_server/Cargo.toml -- both
cargo test --manifest-path examples/eiffel_graceful_drain_server/Cargo.toml
```
