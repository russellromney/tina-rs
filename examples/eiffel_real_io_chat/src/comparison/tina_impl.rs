...
use tina::prelude::*;
use tina_runtime::{
    CallError, DefaultThreadedMailboxFactory, ListenerId, RuntimeEvent, RuntimeEventKind,
    SendOutcome, SendRejectedReason, StreamId, ThreadedRuntime, ThreadedRuntimeConfig,
...
#[tina_runtime::isolate(message = SlowClientMsg)]
impl SlowClient {
    fn handle(&mut self, msg: SlowClientMsg, _ctx: &mut Context<'_, SingleShard>) -> Effect<Self> {
        match msg {
