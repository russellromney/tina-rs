...
```sh
cargo run --manifest-path examples/eiffel_cancellation_chain/Cargo.toml -- both
cargo test --manifest-path examples/eiffel_cancellation_chain/Cargo.toml
```
