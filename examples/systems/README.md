...
| `system_bounded_object_lane` | Tiny S3-shaped object lane stand-in with concurrent callers, bounded in-flight work, and typed busy replies. | Request contexts, runtime-owned time, bounded in-flight admission, pressure vocabulary. |
