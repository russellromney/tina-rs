...
```sh
cargo run --manifest-path examples/specimen_replay_dst/Cargo.toml -- both
cargo run --manifest-path examples/specimen_replay_dst/Cargo.toml -- tokio
cargo run --manifest-path examples/specimen_replay_dst/Cargo.toml -- tina
```
