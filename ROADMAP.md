...
| **125 Supervision and failure domains** | Post-122 core wave. Local multi-shard child ownership, parent-stop cleanup, replacement address refresh, failed-shard ingress truth, non-panic failure policy, and supervisor reports. Plan outline: `.intent/phases/125-supervision-failure-domains/plan.md`. |
