...
| **106 Lifecycle, health, and topology** | Make production service life boring: health/readiness/liveness, topology reports, shutdown choreography, resource close/drain reports, and one copied production skeleton specimen. Plan: `.intent/phases/106-lifecycle-health-topology/plan.md`. |
