...
| Phase | Purpose |
|---|---|
| **103 Protocol parity finish** | Finish the native protocol replacement story: HTTP/2 flow-control truth, gRPC streaming/final-status ownership, WebSocket browser `ws`/`wss` replacement behavior, real-client interop, bad-peer pressure, and simulator facts for the claimed modes. Plan: `.intent/phases/103-protocol-parity-finish/plan.md`. |
