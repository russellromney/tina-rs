...
| **064 service bootstrap and fanout ergonomics** | Follow up on 062/053/061 discoveries: design self-address registration, a narrow scatter/gather helper if repeated specimens prove it, better bridge setup unification, host barrier/fixture cleanup if it repeats, and docs for when to keep explicit state-machine variants instead of hiding them behind flow macros. |
