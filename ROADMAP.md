...
| **088 AWS bridge first form** | Bounded S3 bridge first: object put/get/head, explicit body caps, caller-owned retry/idempotency, shutdown, timeout/cancel/abandoned truth, metrics, and fake-local CI. SQS/Dynamo/SNS wait until S3 proves the bridge shape. Plan: `.intent/phases/088-aws-bridge-first-form/plan.md`. |
