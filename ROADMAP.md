...
| Phase | Purpose |
|---|---|
| **Seastar-core runtime shape** | Build the missing local-runtime features before the readiness gate: explicit shard/core ownership and optional affinity, per-shard preallocation posture, pool/slab cleanup where clearly worth it, mature driver/substrate lifecycle contract, swappable substrate boundary, minimal fairness/scheduling rail, and a Seastar-principles checklist. |
