...
fn runtime_event_kind_name(kind: RuntimeEventKind) -> Option<RuntimeEventKindName> {
    Some(match kind {
        ...
        RuntimeEventKind::ChildTerminalDelivered { .. } => {
            RuntimeEventKindName::ChildTerminalDelivered
        }
        RuntimeEventKind::ChildTerminalDisposed { .. } => {
            RuntimeEventKindName::ChildTerminalDisposed
        }
        ...
        RuntimeEventKind::CallCompletionAction { .. } => RuntimeEventKindName::CallCompletionAction,
...
fn every_kind_except(keep: &[RuntimeEventKindName]) -> Vec<RuntimeEventKindName> {
    ...
    let all = [
        ...
        N::ChildStopped,
        N::ChildTerminalDelivered,
        N::ChildTerminalDisposed,
        N::ChildStarted,
