...
fn flow_macro_authority_failures_are_pinned() {
    ...
    cases.compile_fail("tests/flow_macro_compile_fail/raw_request_double_reply.rs");
    cases.compile_fail("tests/flow_macro_compile_fail/raw_request_forgotten_request.rs");
